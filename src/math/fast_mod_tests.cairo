...
// test bn::math::fast_mod_tests::bench::div ... ok (gas usage est.: 82700)
// test bn::math::fast_mod_tests::bench::div_u ... ok (gas usage est.: 58410)
// test bn::math::fast_mod_tests::bench::inv ... ok (gas usage est.: 35270)
// test bn::math::fast_mod_tests::bench::mul ... ok (gas usage est.: 49130)
// test bn::math::fast_mod_tests::bench::mul_u ... ok (gas usage est.: 23540)
// test bn::math::fast_mod_tests::bench::reduce ... ok (gas usage est.: 8250)
// test bn::math::fast_mod_tests::bench::scl ... ok (gas usage est.: 35730)
// test bn::math::fast_mod_tests::bench::scl_u ... ok (gas usage est.: 8740)
// test bn::math::fast_mod_tests::bench::sqr ... ok (gas usage est.: 45100)
// test bn::math::fast_mod_tests::bench::sqr_u ... ok (gas usage est.: 19510)
...
// test bn::math::fast_mod_tests::bench::u512_scl ... ok (gas usage est.: 18160)
...
// test bn::math::fast_mod_tests::test_all_mod_ops ... ok (gas usage est.: 452500)
