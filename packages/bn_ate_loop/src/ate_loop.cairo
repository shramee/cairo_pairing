...
pub fn ate_miller_loop<TRunner, TAccumulator, +MillerRunner<TRunner, TAccumulator>, +Drop<TRunner>>(
    runner: TRunner
) -> TAccumulator {
    ...
    _loop_inner_1_of_2(@runner, ref q_acc);
    _loop_inner_2_of_2(@runner, ref q_acc);
    q_acc
}

pub fn _loop_inner_1_of_2<TRunner, TAccumulator, +MillerRunner<TRunner, TAccumulator>>(
...
pub fn _loop_inner_2_of_2<TRunner, TAccumulator, +MillerRunner<TRunner, TAccumulator>>(
    runner: @TRunner, ref q_acc: TAccumulator
) {
