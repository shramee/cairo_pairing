...
#[inline(always)]
pub fn u512_add_overflow(lhs: u512, rhs: u512) -> (u512, bool) {
    let lhs: u256X2 = lhs.into();
    let rhs: u256X2 = rhs.into();
...
#[inline(always)]
pub fn u512_sub_overflow(lhs: u512, rhs: u512) -> (u512, bool) {
    let lhs: u256X2 = lhs.into();
    let rhs: u256X2 = rhs.into();
...
#[inline(always)]
pub fn u512_high_add(lhs: u512, rhs: u256) -> Result<u512, u512> {
...
#[inline(always)]
pub fn u512_high_sub(lhs: u512, rhs: u256) -> Result<u512, u512> {
    let u512 { limb0, limb1, limb2: low, limb3: high } = lhs;
    let lhs = u256 { low, high };
...
#[inline(always)]
pub fn u512_reduce(a: u512, modulo: NonZero<u256>) -> u256 {
    let (_, rem_u256) = core::integer::u512_safe_div_rem_by_u256(a, modulo);
    rem_u256
}
