pub use core::integer::{u128_overflowing_add, u128_overflowing_sub, u512};
pub use core::panic_with_felt252;
...
#[inline(always)]
pub fn u128_add_with_carry(a: u128, b: u128) -> (u128, u128) nopanic {
...
#[inline(always)]
pub fn u128_wrapping_sub(lhs: u128, rhs: u128) -> u128 implicits(RangeCheck) nopanic {
...
#[inline(always)]
pub fn u256_wrapping_add(lhs: u256, rhs: u256) -> u256 implicits(RangeCheck) nopanic {
...
#[inline(always)]
pub fn u256_wrapping_sub(lhs: u256, rhs: u256) -> u256 implicits(RangeCheck) nopanic {
...
#[inline(always)]
pub fn expect_u256(result: Result<u256, u256>, panic_msg: felt252) -> u256 {
    match result {
...
#[inline(always)]
pub fn expect_u128(result: Result<u128, u128>, panic_msg: felt252) -> u128 {
    match result {
        Result::Ok(value) => value,
        Result::Err(value) => {
            panic_with_felt252(panic_msg);
...
pub impl u512Display of Display<u512> {
...
pub impl Tuple2Add<T1, T2, +Add<T1>, +Add<T2>, +Drop<T1>, +Drop<T2>> of Add<(T1, T2)> {
    #[inline(always)]
...
pub impl Tuple2Sub<T1, T2, +Sub<T1>, +Sub<T2>, +Drop<T1>, +Drop<T2>> of Sub<(T1, T2)> {
    #[inline(always)]
